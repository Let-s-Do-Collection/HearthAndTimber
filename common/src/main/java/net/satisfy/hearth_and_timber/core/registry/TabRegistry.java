...
public class TabRegistry {
    ...
    public static final RegistrySupplier<CreativeModeTab> HEARTH_AND_TIMBER_TAB = CREATIVE_MODE_TABS.register("hearth_and_timber", () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(ObjectRegistry.OAK_SHINGLES_BLOCK.get());
                output.accept(ObjectRegistry.SPRUCE_SHINGLES_BLOCK.get());
                output.accept(ObjectRegistry.BIRCH_SHINGLES_BLOCK.get());
                output.accept(ObjectRegistry.JUNGLE_SHINGLES_BLOCK.get());
                output.accept(ObjectRegistry.ACACIA_SHINGLES_BLOCK.get());
                output.accept(ObjectRegistry.DARK_OAK_SHINGLES_BLOCK.get());
                output.accept(ObjectRegistry.MANGROVE_SHINGLES_BLOCK.get());
                output.accept(ObjectRegistry.CHERRY_SHINGLES_BLOCK.get());
                output.accept(ObjectRegistry.PALE_OAK_SHINGLES_BLOCK.get());
                output.accept(ObjectRegistry.OAK_SHINGLES_STAIRS.get());
                output.accept(ObjectRegistry.SPRUCE_SHINGLES_STAIRS.get());
                output.accept(ObjectRegistry.BIRCH_SHINGLES_STAIRS.get());
                output.accept(ObjectRegistry.JUNGLE_SHINGLES_STAIRS.get());
                output.accept(ObjectRegistry.ACACIA_SHINGLES_STAIRS.get());
                output.accept(ObjectRegistry.DARK_OAK_SHINGLES_STAIRS.get());
                output.accept(ObjectRegistry.MANGROVE_SHINGLES_STAIRS.get());
                output.accept(ObjectRegistry.CHERRY_SHINGLES_STAIRS.get());
                output.accept(ObjectRegistry.PALE_OAK_SHINGLES_STAIRS.get());
                output.accept(ObjectRegistry.OAK_SHINGLES_SLAB.get());
                output.accept(ObjectRegistry.SPRUCE_SHINGLES_SLAB.get());
                output.accept(ObjectRegistry.BIRCH_SHINGLES_SLAB.get());
                output.accept(ObjectRegistry.JUNGLE_SHINGLES_SLAB.get());
                output.accept(ObjectRegistry.ACACIA_SHINGLES_SLAB.get());
                output.accept(ObjectRegistry.DARK_OAK_SHINGLES_SLAB.get());
                output.accept(ObjectRegistry.MANGROVE_SHINGLES_SLAB.get());
                output.accept(ObjectRegistry.CHERRY_SHINGLES_SLAB.get());
                output.accept(ObjectRegistry.PALE_OAK_SHINGLES_SLAB.get());
