...
public class RubbleMasonryBlock extends Block implements IRubbleMasonry {
    private final Supplier<Block> nextBlock;
    private final Supplier<Block> previousBlock;

    public RubbleMasonryBlock(BlockBehaviour.Properties properties, Supplier<Block> nextBlock, Supplier<Block> previousBlock) {
        super(properties);
    ...
    @Override
    public void appendHoverText(ItemStack itemStack, TooltipContext tooltipContext, List<Component> tooltipList, TooltipFlag tooltipFlag) {
