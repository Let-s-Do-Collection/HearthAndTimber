...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> CATTLEGRID = registerWithItem("cattlegrid", () -> new net.satisfy.meadow.core.block.CattlegridBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(2.0f, 6.0f).noOcclusion()));
