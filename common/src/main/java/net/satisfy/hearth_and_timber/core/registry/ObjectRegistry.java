...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> COVERED_RUBBLESTONE_STAIRS = registerWithItem("covered_rubblestone_stairs", () -> new RubbleMasonryStairs(() -> ObjectRegistry.COVERED_RUBBLESTONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_STAIRS), () -> ObjectRegistry.PLASTERED_RUBBLESTONE_STAIRS.get(), () -> null));
    public static final RegistrySupplier<Block> COVERED_RUBBLESTONE_SLAB = registerWithItem("covered_rubblestone_slab", () -> new RubbleMasonrySlab(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_SLAB), () -> ObjectRegistry.PLASTERED_RUBBLESTONE_SLAB.get(), () -> null));
    public static final RegistrySupplier<Block> COVERED_RUBBLESTONE_WALL = registerWithItem("covered_rubblestone_wall", () -> new RubbleMasonryWall(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_WALL), () -> ObjectRegistry.PLASTERED_RUBBLESTONE_WALL.get(), () -> null));
    ...
    public static final RegistrySupplier<Block> PLASTERED_RUBBLESTONE_STAIRS = registerWithItem("plastered_rubblestone_stairs", () -> new RubbleMasonryStairs(() -> ObjectRegistry.PLASTERED_RUBBLESTONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_STAIRS), () -> ObjectRegistry.POINTED_RRUBBLESTONE_STAIRS.get(), () -> ObjectRegistry.COVERED_RUBBLESTONE_STAIRS.get()));
    public static final RegistrySupplier<Block> PLASTERED_RUBBLESTONE_SLAB = registerWithItem("plastered_rubblestone_slab", () -> new RubbleMasonrySlab(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_SLAB), () -> ObjectRegistry.POINTED_RRUBBLESTONE_SLAB.get(), () -> ObjectRegistry.COVERED_RUBBLESTONE_SLAB.get()));
    public static final RegistrySupplier<Block> PLASTERED_RUBBLESTONE_WALL = registerWithItem("plastered_rubblestone_wall", () -> new RubbleMasonryWall(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_WALL), () -> ObjectRegistry.POINTED_RRUBBLESTONE_WALL.get(), () -> ObjectRegistry.COVERED_RUBBLESTONE_WALL.get()));
    ...
    public static final RegistrySupplier<Block> POINTED_RRUBBLESTONE_STAIRS = registerWithItem("pointed_rubblestone_stairs", () -> new RubbleMasonryStairs(() -> ObjectRegistry.POINTED_RUBBLESTONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_STAIRS), () -> ObjectRegistry.GROUTLESS_RUBBLESTONE_STAIRS.get(), () -> ObjectRegistry.PLASTERED_RUBBLESTONE_STAIRS.get()));
    public static final RegistrySupplier<Block> POINTED_RRUBBLESTONE_SLAB = registerWithItem("pointed_rubblestone_slab", () -> new RubbleMasonrySlab(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_SLAB), () -> ObjectRegistry.GROUTLESS_RUBBLESTONE_SLAB.get(), () -> ObjectRegistry.PLASTERED_RUBBLESTONE_SLAB.get()));
    public static final RegistrySupplier<Block> POINTED_RRUBBLESTONE_WALL = registerWithItem("pointed_rubblestone_wall", () -> new RubbleMasonryWall(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_WALL), () -> ObjectRegistry.GROUTLESS_RUBBLESTONE_WALL.get(), () -> ObjectRegistry.PLASTERED_RUBBLESTONE_WALL.get()));
    ...
    public static final RegistrySupplier<Block> GROUTLESS_RUBBLESTONE_STAIRS = registerWithItem("groutless_rubblestone_stairs", () -> new RubbleMasonryStairs(() -> ObjectRegistry.GROUTLESS_RUBBLESTONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_STAIRS), () -> null, () -> ObjectRegistry.POINTED_RRUBBLESTONE_STAIRS.get()));
    public static final RegistrySupplier<Block> GROUTLESS_RUBBLESTONE_SLAB = registerWithItem("groutless_rubblestone_slab", () -> new RubbleMasonrySlab(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_SLAB), () -> null, () -> ObjectRegistry.POINTED_RRUBBLESTONE_SLAB.get()));
    public static final RegistrySupplier<Block> GROUTLESS_RUBBLESTONE_WALL = registerWithItem("groutless_rubblestone_wall", () -> new RubbleMasonryWall(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_WALL), () -> null, () -> ObjectRegistry.POINTED_RRUBBLESTONE_WALL.get()));
