...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> OAK_SHINGLES_STAIRS = registerWithItem("oak_shingles_stairs", () -> new StairBlock(OAK_SHINGLES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_STAIRS)));
    public static final RegistrySupplier<Block> SPRUCE_SHINGLES_STAIRS = registerWithItem("spruce_shingles_stairs", () -> new StairBlock(SPRUCE_SHINGLES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.SPRUCE_STAIRS)));
    public static final RegistrySupplier<Block> BIRCH_SHINGLES_STAIRS = registerWithItem("birch_shingles_stairs", () -> new StairBlock(BIRCH_SHINGLES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.BIRCH_STAIRS)));
    public static final RegistrySupplier<Block> JUNGLE_SHINGLES_STAIRS = registerWithItem("jungle_shingles_stairs", () -> new StairBlock(JUNGLE_SHINGLES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.JUNGLE_STAIRS)));
    public static final RegistrySupplier<Block> ACACIA_SHINGLES_STAIRS = registerWithItem("acacia_shingles_stairs", () -> new StairBlock(ACACIA_SHINGLES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.ACACIA_STAIRS)));
    public static final RegistrySupplier<Block> DARK_OAK_SHINGLES_STAIRS = registerWithItem("dark_oak_shingles_stairs", () -> new StairBlock(DARK_OAK_SHINGLES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.DARK_OAK_STAIRS)));
    public static final RegistrySupplier<Block> MANGROVE_SHINGLES_STAIRS = registerWithItem("mangrove_shingles_stairs", () -> new StairBlock(MANGROVE_SHINGLES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.MANGROVE_STAIRS)));
    public static final RegistrySupplier<Block> CHERRY_SHINGLES_STAIRS = registerWithItem("cherry_shingles_stairs", () -> new StairBlock(CHERRY_SHINGLES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_STAIRS)));
    public static final RegistrySupplier<Block> PALE_OAK_SHINGLES_STAIRS = registerWithItem("pale_oak_shingles_stairs", () -> new StairBlock(PALE_OAK_SHINGLES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_STAIRS)));
