...
public class EntityTypeRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<FoundationBlockEntity>> FOUNDATION_BLOCK_ENTITY = registerBlockEntity("foundation", () -> BlockEntityType.Builder.of(FoundationBlockEntity::new, FOUNDATION_BLOCK.get(), FIREPLACE_CORNICE.get()).build(null));
