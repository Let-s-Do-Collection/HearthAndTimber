...
public class EntityTypeRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<TimberFoundationBlockEntity>> FOUNDATION_BLOCK_ENTITY = registerBlockEntity("foundation", () -> BlockEntityType.Builder.of(TimberFoundationBlockEntity::new, TIMBER_FOUNDATION.get(), TIMBER_BASE_TRIM.get(), TIMBER_BASE_SKIRT.get(), TIMBER_FRAME.get(), TIMBER_GRID_FRAME.get(), TIMBER_CROSS_FRAME.get(), TIMBER_DIAGONAL_FRAME.get(), TIMBER_FRAME_STAIRS.get()).build(null));
